...
class TestV1Parser(TestCase):
    ...
    def test_parse_value_item(self):
        parser = V1CommandParser()
        self.assertEqual(parser.parse_value("LAST"), {"type": "wikibase-entityid", "value": {"entity-type": "item", "id": "LAST"}})
        self.assertEqual(parser.parse_value("Q1233"), {"type": "wikibase-entityid", "value": {"entity-type": "item", "id": "Q1233"}})
        self.assertEqual(parser.parse_value("M1233"), {"type": "wikibase-entityid", "value": {"entity-type": "item", "id": "M1233"}})
    ...
    def test_parse_value_time(self):
        parser = V1CommandParser()
        ret = {'type': 'time', 'value': {'time': '+1967-01-17T00:00:00Z', 'timezone': 0, 'before': 0, 'after': 0, 'precision': 11, 'calendarmodel': 'http://www.wikidata.org/entity/Q1985727'}}
        self.assertEqual(parser.parse_value("+1967-01-17T00:00:00Z/11"), ret)
        ret = {'type': 'time', 'value': {'time': '+1967-01-00T00:00:00Z', 'timezone': 0, 'before': 0, 'after': 0, 'precision': 10, 'calendarmodel': 'http://www.wikidata.org/entity/Q1985727'}}
        self.assertEqual(parser.parse_value("+1967-01-00T00:00:00Z/10"), ret)
        ret = {'type': 'time', 'value': {'time': '+1967-00-00T00:00:00Z', 'timezone': 0, 'before': 0, 'after': 0, 'precision': 9, 'calendarmodel': 'http://www.wikidata.org/entity/Q1985727'}}
    ...
    def test_parse_value_quantity(self):
        ...
        ret = {"type": "quantity", "value": {"amount": "9", "upperBound": 9.1, "lowerBound": 8.9,}}
        ...
        ret = {"type": "quantity", "value": {"amount": "9.6", "upperBound": 9.7, "lowerBound": 9.5,}}
