...
MIDDLEWARE = [
    ...
    "quickstatements.apps.web.middleware.language_cookie_middleware",
]

ROOT_URLCONF = "quickstatements.service.urls"
...
# WSGI_APPLICATION = "quickstatements.service.wsgi.application"
...
# Base REST url
BASE_REST_URL = os.getenv("BASE_REST_URL", "https://www.wikidata.org/w/rest.php")
